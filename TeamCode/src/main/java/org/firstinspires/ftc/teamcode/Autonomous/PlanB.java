...
@Config
@Autonomous(name = "PlanB")
public class PlanB extends LinearOpMode {
...
//            move2(0.6,kd,kp,0,0,90);
            ...
            L2.setPower(0);
            neep.setPosition(0.4);
            move2(-0.4,-0.4,-0.4,-0.4,kd,kp,400.0,0);
            neep.setPosition(0.1);
            move2(0.4,-0.4,-0.4,0.4,kd,kp,1500.0,0);
            ...
            move2(0.4,0.4,0.4,0.4,kd,kp,80,0);
