    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            // Put run blocks here.
              ...
              move2(0.35, 0.08, 0.25,0.008, 0.01,0.05, 0, -10000, 30);
              move2(0.35, 0.08, 0.25,0.008, 0.01,0.05, 0, -10000, 0);
              move2(0.35, 0.08, 0.25,0.008, 0.01,0.05, 0, -1000, 0);
              move2(0.35, 0.08, 0.25,0.008, 0.01,0.05, 0, -1000, 90);
              move2(0.35, 0.08, 0.25,0.008, 0.01,0.05, -30000, -1000, 90);
