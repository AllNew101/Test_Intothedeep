...
@Config
@Autonomous
public class T02 extends LinearOpMode {
...
//    public static String ALTIMGSRC =
    ...
    public static String ALTIMGSRC = "/images/test.jpg";
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            packet.fieldOverlay()
                    .setTranslation(ORIGIN_OFFSET_X,ORIGIN_OFFSET_Y)
                    .setRotation(ORIGIN_ZEROHEADING)
                    .setScale(SCALEX,SCALEY)
                    .drawImage("/dash/centerstage.webp", 0, 0, 144, 144)
...
//                    //all other drawing primitives are rendered in the current (or default) transform, as built using setTranslation, setRotation and setScale
 //                   .setAlpha(.25)
                    .drawImage("/images/test.jpg", 0, 0, 24, 24)
//
...
//                    .drawImage("/dash/centerstage.png", 24, 24, 24, 24, angleAnim, 24, 24, false)
//                    .setAlpha(1.0)
